   ...
   <table>
    <tbody>
      <tr>
        ...
        <td>
          <input disabled="disabled" type="submit" class="ml-5" value="작성" />
        </td>
      </tr>  
     </tbody>
    </table>
    ...
    <tbody>
     ...
     <c:forEach var="reply" items="${replies}">
        ...
        <tr>
         ...
         <td>
           <textarea required="required" name ="body" class="w-96 h-5 ml-5" rows="10" >${reply.body}</textarea>
         </td>
         <td><input class="btn btn-primary ml-3" type="submit" value="수정완료" /></td>
        </tr>      
     </c:forEach>  
     </form>
    </tbody>
